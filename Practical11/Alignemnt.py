...
seq_human = file1.readlines()
seq_mouse = file2.readlines()
seq_random = file3.readlines()

#list the sequences
for line in seq_human:
    if not line.startswith('>'):
        seq1=line.split()[0]
        
for line in seq_mouse:
    if not line.startswith('>'):
        seq2=line.split()[0]

for line in seq_random:
    if not line.startswith('>'):
        seq3=line.split()[0]
...
#input the Blosum62 matrix to calculate #BLOSUM62
#(BLOSUM62 source is adopted from https://www.ncbi.nlm.nih.gov/Class/FieldGuide/BLOSUM62.txt)
...
def score(a,b,score):
	for i in range (len(a)):
		score=score+blosum[amino.index(a[i])][amino.index(b[i])]
	return score

print('the score of human and mouse is '+str(score(seq1,seq2,0)))
print('the score of human and mouse is '+str(score(seq1,seq3,0)))
print('the score of human and mouse is '+str(score(seq2,seq3,0)))
